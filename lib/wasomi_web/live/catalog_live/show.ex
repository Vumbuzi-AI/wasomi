defmodule WasomiWeb.CatalogLive.Show do
  ...
  attr :lecture_count, :integer, required: true
        ...
        <div class="mx-auto max-w-container px-5 lg:px-8">
          ...
          <div class="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_380px] lg:items-stretch">
            ...
            <div id="enroll" class="rounded-3xl border border-black/5 bg-white p-6 shadow-card">
              ...
              <.link
                href={~p"/courses/#{@course.slug}/checkout"}
              ...
              >
                {if @course.is_free, do: "Enroll for Free", else: "Enroll & Pay"}
              ...
              <p :if={!@current_user} class="mt-3 text-center text-sm text-muted">
                You'll sign in or create an account first — it takes a minute.
              </p>
            </div>
          </div>
        </div>
