defmodule WasomiWeb.AdminLive.Settings do
  @moduledoc """
  Account settings for administrators: change the sign-in email (with a
  confirmation link to the new address) and the password. Deliberately
  narrower than the learner settings page — admins have no public profile,
  so there is nothing else to manage here.
  """
    ...
    <.admin_layout active={:settings} current_user={@current_user}>
      <div class="w-full space-y-6 px-5 py-8 lg:px-8">
        <.page_header title="Account settings">
          <:subtitle>
            Manage the email and password you use to sign in to the admin area.
          </:subtitle>
        </.page_header>
        ...
        <div class="rounded-3xl border border-black/5 bg-white p-6 shadow-card sm:p-8">
          <div class="max-w-2xl space-y-10">
            <div>
              <h2 class="text-base font-semibold text-ink">Email address</h2>
