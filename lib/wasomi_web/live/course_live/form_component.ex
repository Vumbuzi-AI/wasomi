    ...
    <div>
      ...
      >
        ...
        <div class="space-y-2">
          ...
          />
          <p class="text-xs text-zinc-500">
            Shown to learners as the course's learning time. Leave blank to fall back to the
            total length of the course's videos, which won't account for reading, practice or
            quizzes.
          </p>
        </div>
