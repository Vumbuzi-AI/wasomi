...
config :wasomi,
  ...
  cloudflare_stream_customer_code: "test-customer-code",
  cloudflare_account_id: "test-account-id",
  cloudflare_stream_api_token: "test-stream-token",
  cloudflare_stream_req_options: [plug: {Req.Test, Wasomi.Media.Cloudflare}, retry: false],
  certificate_renderer: Wasomi.CertificateRendererMock,
  receipt_renderer: Wasomi.ReceiptRendererMock,
  ...
  smart_test_generator: Wasomi.SmartTestGeneratorMock,
  study_guide_generator: Wasomi.StudyGuideGeneratorMock,
