defmodule WasomiWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: WasomiWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import WasomiWeb.CoreComponents
      # Shared learner sidebar chrome
      import WasomiWeb.StudentComponents
      # Shared admin sidebar chrome
      import WasomiWeb.AdminComponents
